...
// static variables/functions
    ...
    $("#rssMenu").append("  Text:<input type='text' id='newButtonText'><button onclick='appGlobals.currentObject().changeLabel()'>Update</button>")
}
RssWidget.buttomImage='images/button_icon.png'
RssWidget.typeId= 'rss'
RssWidget.myClass= 'widget_rss'
RssWidget.initialWidth='100'
RssWidget.initialHeight= '50'
